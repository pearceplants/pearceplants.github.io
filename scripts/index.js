...
(function () {
  ...
  p1.innerHTML =
    'I’m a botany researcher currently located in the Salt Lake Valley. I am primarily interested the systematics, evolution, and pollination ecology of native plants, with a focus on the genus <i>Ribes</i> (currants and gooseberries).';

  const p2 = document.createElement('p');
  p2.textContent =
    'I also love using macro photography to document natural history, with a focus on capturing the small and overlooked organisms that surround us. I spend much of my free time looking for cool plants and insects, taking and editing macro photos to showcase their morphology.';
